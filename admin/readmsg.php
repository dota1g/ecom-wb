...
$emailID = $_GET['id'];
$getEmail = "SELECT *, email.userID as userID, users.username as username, users.firstName as firstname, users.lastname as lastname
from (email inner join users on email.userID = users.userID)
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body p-0">
                  <div class="mailbox-read-info">
                    ...
                    <h6>From: <?php echo $emailRow['firstname'] ." ". $emailRow['lastname']?>
                    ...
                    <?php 
                      if($emailRow['orderID'] != 0){
                        ...
                        The customer is messaging about this order: ".$itsfuckinrow['productName']."<br/>
                  ...
                  <div class="card-footer">
                    ...
                    <?php
                        if ($emailRow['orderID'] != 0){
                          echo
                          "<a href=\"composemsg.php?orderID=".$emailRow['orderID']."&userID=".$emailRow['userID']."\" class=\"btn btn-default btn-sm\" data-container=\"body\" title=\"Reply\">
                          <i class=\"fas fa-reply\"></i>
                          Reply
                        </a>";
                        } else {
                          echo
                          "<a href=\"composemsg.php?userID=".$emailRow['userID']."\" class=\"btn btn-default btn-sm\" data-container=\"body\" title=\"Reply\">
                          <i class=\"fas fa-reply\"></i>
                          Reply
                        </a>";
                        }
