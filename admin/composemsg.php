...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_POST['oID'])) {
    $orderID = $_POST['oID'];
    $emailsql = "INSERT into email (`userID`, `emailSubject`, `emailContent`, `orderID`, `isFromAdmin`) VALUES ('$userID','$subject','$content', '$orderID', 1)";
    $query = mysqli_query($db, $emailsql);
    header('Location:sentmsgs.php');
  } else {
    $emailsql = "INSERT into email (`userID`, `emailSubject`, `emailContent`, `isFromAdmin`) VALUES ('$userID','$subject','$content', 1)";
    $query = mysqli_query($db, $emailsql);
    header('Location:sentmsgs.php');
  }
} 
              ...
              <div class="card card-primary card-outline">
                ...
                <?php 
                      if(isset($_GET['orderID'])){
                        ...
                        You are messaging a customer with this order: ".$itsfuckinrow['productName']."<br/>
                      ...
                      <div class="form-group">
                        UserID
                        <input class="form-control" value="<?php echo $_GET['userID']?>" name="userID" readonly>
                      </div>
                      <div class="form-group">
