          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pending-orders.html" class="nav-link active">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Windblume Admin Panel</h5>

                  <p class="card-text">
                    Built with AdminLTE template - sorry for the creators of this template for the abomination we made
                  </p>
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  <h6 class="card-title">Still just a UI website</h6>

                  <p class="card-text">
                    Backend support surely will come soon
                  </p>
