...
$productresult = mysqli_query($db, $getAllProducts);
            ...
            <?php
                while($row = mysqli_fetch_assoc($productresult)){
                    ...
                    <div class=\"list-group-item\">
                      <div class=\"row\">
                        <div class=\"col-auto\">
                          <img class=\"img-fluid\" style=\"width: 200px; height: auto;\" src=\"../images/".$row['productImg']."\" alt=\"Photo\" style=\"max-height: 160px;\">
                        </div>
                        <div class=\"col px-4\">
                          <div>
