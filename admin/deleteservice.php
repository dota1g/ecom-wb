                    ...
                    <div class="col-md-10 offset-md-1">
                        <div class="list-group">
                            <div class="list-group-item">
                                <div class="row">
                                    <div class="col-auto">
                                        <img class="img-fluid" src="../user/images/fanart.jpg" alt="Photo" style="max-height: 160px;">
                                    </div>
                                    <div class="col px-4">
                                        <div>
                                            <div class="float-right mt-5 flex-row"><a href="addproduct.html" class="btn btn-primary" role="button">Edit</a>
                                              <button type="button" class="btn btn-danger">Delete</button></div>
                                            <h3>Fan Arts</h3>
                                            <p class="mb-3">A fan art of your favorite fictional character, or your own!</p>
                                            <h4 class="mb-2 mt-5" >₱5,499.00<h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
