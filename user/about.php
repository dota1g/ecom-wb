      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/workplace.jpg" alt="Image placeholder" class="img-fluid rounded">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Nikki Tigue</h3>
                  <p class="block-38-subheading">Co-Founder/ General Graphic Designer</p>
                </div>
                <div class="block-38-body">
                  <p>A talented photo enhancer and graphic designer with a passion for creating stunning visuals that capture the essence of a brand or message. With more than 10 years of experience in the industry, Nikki has developed a keen eye for detail and a deep understanding of design principles and techniques.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Rosalyne Luhefalter </h3>
                  <p class="block-38-subheading">Co-Founder/Illustrator and UI/UX Designer</p>
                </div>
                <div class="block-38-body">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Alfred Baltazar</h3>
                  <p class="block-38-subheading">Graphic Designer in Posters</p>
                </div>
                <div class="block-38-body">
                  <p>Meet Alfred, a highly skilled graphic designer with a deep passion for movie/film poster design. <br> With 4 years of experience in the industry, Alfred has established themselves as a leading expert in the field, known for their exceptional creativity, attention to detail, and ability to capture the essence of a film in a single image.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Kyle Schwarber</h3>
