          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/fanart.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Fan Arts</a></h3>
                    <p class="mb-0">A fan art of your favorite fictional character, or your own!</p>
                    <p class="text-primary font-weight-bold">>₱5,499.00</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/ui.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Website UI/UX Design</a></h3>
                    <p class="mb-0">A mockup of your desired website</p>
                    <p class="text-primary font-weight-bold">>₱399.00</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/enhance.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Photo Enhancement</a></h3>
                    <p class="mb-0">Edit lighting, fix blurs and make your image generally better</p>
                    <p class="text-primary font-weight-bold">>₱100.00</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/font.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Business Exclusive Font</a></h3>
                    <p class="mb-0">Custom typeface that only your business can use</p>
                    <p class="text-primary font-weight-bold">₱2,500.00</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/covers.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Social Media Covers</a></h3>
                    <p class="mb-0">Covers for your Facebook or Twitter or YouTube account</p>
                    <p class="text-primary font-weight-bold">₱300.00</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/bro.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Brochures</a></h3>
                    <p class="mb-0">Design for your ads or mini guides</p>
                    <p class="text-primary font-weight-bold">₱199.00</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="images/poster.jpg" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html">Movie/Video Posters</a></h3>
                    <p class="mb-0">For your movie/video teasers</p>
                    <p class="text-primary font-weight-bold">$300.00</p>
                  </div>
                </div>
              </div>
